...
import (
	...
	internalinterfaces "github.com/waveywaves/cloudevents-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/waveywaves/cloudevents-controller/pkg/client/listers/samples/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudeventsV1alpha1().AddressableServices(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudeventsV1alpha1().AddressableServices(namespace).Watch(context.TODO(), options)
			},
		},
