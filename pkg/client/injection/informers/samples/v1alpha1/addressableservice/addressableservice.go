...
func Get(ctx context.Context) v1alpha1.AddressableServiceInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/waveywaves/cloudevents-controller/pkg/client/informers/externalversions/samples/v1alpha1.AddressableServiceInformer from context.")
	}
