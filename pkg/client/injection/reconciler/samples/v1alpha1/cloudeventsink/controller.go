...
import (
	...
	cloudeventsink "github.com/waveywaves/cloudevents-controller/pkg/client/injection/informers/samples/v1alpha1/cloudeventsink"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "cloudeventsink-controller"
	defaultFinalizerName       = "cloudeventsinks.cloudevents.waveywaves.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	cloudeventsinkInformer := cloudeventsink.Get(ctx)

	lister := cloudeventsinkInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "cloudevents.waveywaves.dev.CloudeventSink"),
	)
