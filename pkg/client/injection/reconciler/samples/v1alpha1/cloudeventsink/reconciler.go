...
type reconcilerImpl struct {
	...
	Lister samplesv1alpha1.CloudeventSinkLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister samplesv1alpha1.CloudeventSinkLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.CloudeventSinks(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.CloudeventSink, desired *v1alpha1.CloudeventSink) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.CloudeventsV1alpha1().CloudeventSinks(desired.Namespace)
		...
		updater := r.Client.CloudeventsV1alpha1().CloudeventSinks(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.CloudeventSink) (*v1alpha1.CloudeventSink, error) {
	...
	getter := r.Lister.CloudeventSinks(resource.Namespace)
	...
	patcher := r.Client.CloudeventsV1alpha1().CloudeventSinks(resource.Namespace)
