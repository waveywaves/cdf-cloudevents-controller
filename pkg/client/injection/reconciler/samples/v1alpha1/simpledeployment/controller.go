...
const (
	defaultControllerAgentName = "simpledeployment-controller"
	defaultFinalizerName       = "simpledeployments.samples.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	simpledeploymentInformer := simpledeployment.Get(ctx)

	lister := simpledeploymentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "samples.knative.dev.SimpleDeployment"),
	)
