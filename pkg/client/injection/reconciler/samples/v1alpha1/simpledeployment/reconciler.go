...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister samplesv1alpha1.SimpleDeploymentLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.SimpleDeployments(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.SimpleDeployment, desired *v1alpha1.SimpleDeployment) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			...
			getter := r.Client.SamplesV1alpha1().SimpleDeployments(desired.Namespace)
		...
		updater := r.Client.SamplesV1alpha1().SimpleDeployments(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.SimpleDeployment) (*v1alpha1.SimpleDeployment, error) {
	...
	patcher := r.Client.SamplesV1alpha1().SimpleDeployments(resource.Namespace)
